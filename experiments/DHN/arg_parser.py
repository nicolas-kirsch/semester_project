...
def argument_parser():
    ...
    # controller
    parser.add_argument('--cont-type', type=str, default='PerfBooster', help='Controller type. Can be Affine, NN, or PerfBoost.')       ## added
    ...
    parser.add_argument('--l', type=int, default=8, help='size of the non-linear part of REN. Default is 8.')   # default was 4
...
def print_args(args):
    """
    Print the arguments passed to the script in a formatted manner.
    """
